...
dotnet ../tools/sonar/SonarScanner.MSBuild.dll begin /o:"chuckfork" /k:"ChuckFork_SuperSocket" /d:sonar.cs.vstest.reportsPaths="**/TestResults/*.trx" /d:sonar.host.url="https://sonarcloud.io" /d:sonar.verbose=true /d:sonar.login=${SONAR_TOKEN}
echo "Running build..."
